 ...
 */
template <Gem::Hap2::RANDFLAVOURS s = Gem::Hap2::RANDFLAVOURS::RANDOMPROXY>
class GRandomT : public Gem::Hap2::GRandomBase {
public:
    /***************************************************************************/
 ...
 */
template <>
class GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> : public Gem::Hap2::GRandomBase {
public:
    /***************************************************************************/
    /**
	 ...
	 * to make this happen.
	 */
    GRandomT([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> const & cp) noexcept(false)
      : GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY>() { /* nothing */
    }
	 ...
	 */
    GRandomT(GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> &&cp) noexcept(false)
      : p_(std::move(cp.p_))
      , grf_(randomFactory()) // Make sure we have a local pointer to the factory
    {
	 ...
	 */
    GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> &
    operator=([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> const & cp) noexcept(false) {
        return *this;
    }
	 ...
	 */
    GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> &
    operator=(GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY> &&cp) noexcept(false) {
        p_ = std::move(cp.p_);
...
private:
    ...
    std::shared_ptr<Gem::Hap2::GRandomFactory> grf_;
};

/** @brief Convenience typedef */
using GRandom = GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMPROXY>;
 ...
 */
template <>
class GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> : public Gem::Hap2::GRandomBase {
public:
    /***************************************************************************/
    /**
	 ...
	 */
    GRandomT([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> const & cp) noexcept(false)
      : GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL>() { /* nothing */
    }
	 ...
	 */
    GRandomT([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> && cp) noexcept(false)
      : GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL>() { /* nothing */
    }
	 ...
	 */
    GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> &
    operator=([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> const & cp) noexcept(
        false
	 ...
	 */
    GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> &
    operator=([[maybe_unused]] GRandomT<Gem::Hap2::RANDFLAVOURS::RANDOMLOCAL> && cp) noexcept(false) {
        return *this;
    }
