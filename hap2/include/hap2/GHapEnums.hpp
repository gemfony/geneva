...
/******************************************************************************/
/**
     * Allowed specializations of Gem::Hap2::GRandomT<T>
     */
...
/** @brief Puts a Gem::Hap2::RANDFLAVOURS into a stream. Needed also for boost::lexical_cast<> */
std::ostream &operator<<(std::ostream &, const Gem::Hap2::RANDFLAVOURS &);
/** @brief Reads a Gem::Hap2::RANDFLAVOURS item from a stream. Needed also for boost::lexical_cast<> */
std::istream &operator>>(std::istream &, Gem::Hap2::RANDFLAVOURS &);
