...
void createRandomVector(
    ...
    std::shared_ptr<Gem::Hap2::GRandomBase> gr_ptr
) {
    std::size_t i;

    std::normal_distribution<double> normal_distribution(-3., 1.);
    Gem::Hap2::bi_normal_distribution<double> bi_normal_distribution(-3, 0.5, 0.5, 3.);
...
int main(int argc, char **argv) {
    ...
    std::shared_ptr<Gem::Hap2::GRandomBase> gr_ptr_one;
    std::shared_ptr<Gem::Hap2::GRandomBase> gr_ptr_two;
    ...
    // correlation.
    {
        std::uniform_real_distribution<double> uniform_real_distribution(0., 1.);
        for(i = 1; i <= 10; i++) {
            std::shared_ptr<Gem::Hap2::GRandomBase> gr_ptr_seed;
            switch(rnrProductionMode) {
            case 0:
