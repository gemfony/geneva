...
"    # the manifest is a JSON array of per-plotter GPlotSpec objects\n"
"    man = json.loads(bytes(z.read('manifest.json')).decode())\n"
"    assert isinstance(man, list), 'manifest is not a JSON array: ' + repr(type(man))\n"
"    assert len(man) >= 1, 'empty manifest'\n"
"    # every entry must be a valid GPlotSpec describing the plot\n"
"    for entry in man:\n"
"        for key in ('kind', 'role', 'name', 'columns'):\n"
"            assert key in entry, 'manifest entry missing ' + key + ': ' + repr(entry)\n"
"    assert man[0]['name'] == 'data graph', man[0]\n"
"    assert man[0]['kind'] == 'graph_2d', man[0]\n"
"    assert man[0]['role'] == 'xy', man[0]\n"
"    assert man[0]['columns'] == ['x', 'y'], man[0]\n"
"\n"
