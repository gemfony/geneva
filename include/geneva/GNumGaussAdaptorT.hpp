...
public:
	 ...
	 */
	G_API_GENEVA GNumGaussAdaptorT()
		: GAdaptorT<num_type> ()
	 ...
	 */
	G_API_GENEVA GNumGaussAdaptorT(const double& probability)
	 ...
	 */
	G_API_GENEVA GNumGaussAdaptorT(const GNumGaussAdaptorT<num_type, fp_type>& cp)
	 ...
	 * allocated data.
	 */
	virtual G_API_GENEVA ~GNumGaussAdaptorT()
	{ /* nothing */ }
    ...
    * a constraint of [0,1], so it is not necessary in this function.
	 ...
	 */
	G_API_GENEVA void setSigma(const fp_type& sigma)
	{
	 ...
	 */
	G_API_GENEVA fp_type getResetSigma() const  {
		return sigma_reset_;
	}
    ...
    */
	G_API_GENEVA void setResetSigma(const fp_type& sigma_reset)
   {
      // Sigma must be in the allowed value range.
    ...
    */
	G_API_GENEVA fp_type getSigma() const  {
      return sigma_;
   }
    ...
    * is interpreted as a percentage of the allowed or desired value range of the target variable.
	 ...
	 */
	G_API_GENEVA void setSigmaRange(
      const fp_type& minSigma
      , const fp_type& maxSigma
   ){
	   using namespace Gem::Common;
	 ...
	 */
	G_API_GENEVA boost::tuple<fp_type,fp_type> getSigmaRange() const  {
	 ...
	 */
	G_API_GENEVA void setSigmaAdaptionRate(const fp_type& sigmaSigma)
	{
	 ...
	 */
	G_API_GENEVA fp_type getSigmaAdaptionRate() const  {
		return sigmaSigma_;
	}
	 ...
	 */
	virtual G_API_GENEVA std::string printDiagnostics() const OVERRIDE {
