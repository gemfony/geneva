  ...
  : public GAdaptorT<num_type, fp_type> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            BOOST_SERIALIZATION_NVP(sigma_reset_) & BOOST_SERIALIZATION_NVP(sigmaSigma_) &
            BOOST_SERIALIZATION_NVP(minSigma_) & BOOST_SERIALIZATION_NVP(maxSigma_);
    }
    ///////////////////////////////////////////////////////////////////////
...
protected:
    ...
    void load_(const GObject *cp) override {
        ...
        const GNumGaussAdaptorT<num_type, fp_type> *p_load =
            Gem::Common::g_convert_and_compare<GObject, GNumGaussAdaptorT<num_type, fp_type>>(
                cp,
                this
            );
...
template <typename num_type, typename fp_type>
struct is_abstract<const Gem::Geneva::GNumGaussAdaptorT<num_type, fp_type>>
