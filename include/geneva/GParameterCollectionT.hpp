...
public:
	 ...
	 */
	G_API_GENEVA GParameterCollectionT()
	 ...
	 */
	G_API_GENEVA GParameterCollectionT(const GParameterCollectionT<T>& cp)
	 ...
	 */
	virtual G_API_GENEVA ~GParameterCollectionT()
	{ /* nothing */ }
	 ...
	 */
	G_API_GENEVA const GParameterCollectionT<T>& operator=(const GParameterCollectionT<T>& cp)
	{
	 ...
	 */
	G_API_GENEVA bool operator==(const GParameterCollectionT<T>& cp) const {
	 ...
	 */
	inline G_API_GENEVA void swap(GParameterCollectionT<T>& cp) {
	 ...
	 */
	virtual G_API_GENEVA T value(const std::size_t& pos) {
		return this->at(pos);
	}
	 ...
	 */
	virtual G_API_GENEVA void setValue(const std::size_t& pos, const T& val)  {
		this->at(pos) = val;
