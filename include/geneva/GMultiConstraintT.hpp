...
public:
    ...
    */
   G_API_GENEVA GPreEvaluationValidityCheckT()
    ...
    */
   G_API_GENEVA GPreEvaluationValidityCheckT(const GPreEvaluationValidityCheckT<ind_type>& cp)
      : GObject(cp)
    ...
    * The destructor
    */
   virtual G_API_GENEVA ~GPreEvaluationValidityCheckT()
   { /* nothing */ }
    ...
    */
   G_API_GENEVA const GPreEvaluationValidityCheckT<ind_type>& operator=(const GPreEvaluationValidityCheckT<ind_type>& cp)  {
    ...
    */
   G_API_GENEVA bool operator==(const GPreEvaluationValidityCheckT<ind_type>& cp) const {
    ...
    */
   bool G_API_GENEVA isValid(const ind_type *cp, double &validityLevel) const {
    ...
    */
   bool G_API_GENEVA isInvalid(const ind_type *cp, double &validityLevel) const {
    ...
    */
   bool G_API_GENEVA getAllowNegative() const {
    ...
    * Allows to specify whether negative values are considered to be valid
    */
   void G_API_GENEVA setAllowNegative(bool allowNegative) {
...
protected:
    ...
    * derived classes.
    */
   virtual double G_API_GENEVA check_(const ind_type *) const = 0;
...
public:
    ...
    * The default constructor
    */
   G_API_GENEVA GValidityCheckContainerT()
   { /* nothing */ }
    ...
    */
   G_API_GENEVA GValidityCheckContainerT(const std::vector<boost::shared_ptr<GPreEvaluationValidityCheckT<ind_type> > >& validityChecks)
   {
    ...
    * The copy constructor
    */
   G_API_GENEVA GValidityCheckContainerT(const GValidityCheckContainerT<ind_type>& cp)
    ...
    * The destructor
    */
   virtual G_API_GENEVA ~GValidityCheckContainerT()
   { /* nothing */ }
    ...
    * A standard assignment operator
    */
   G_API_GENEVA const GValidityCheckContainerT<ind_type>& operator=(const GValidityCheckContainerT<ind_type>& cp)  {
    ...
    */
   G_API_GENEVA bool operator==(const GValidityCheckContainerT<ind_type>& cp) const {
      using namespace Gem::Common;
      // Means: The expectation of equality was fulfilled, if no error text was emitted (which converts to "true")
    ...
    */
   G_API_GENEVA void addCheck(boost::shared_ptr<GPreEvaluationValidityCheckT<ind_type> > vc_ptr) {
      if(!vc_ptr) {
         glogger
...
protected:
   ...
   virtual G_API_GENEVA double check_(const ind_type *) const = 0;
...
public:
    ...
    * The copy constructor
    */
   G_API_GENEVA GCheckCombinerT(const GCheckCombinerT<ind_type>& cp)
    ...
    * The destructor
    */
   virtual G_API_GENEVA ~GCheckCombinerT()
   { /* nothing */ }
    ...
    * A standard assignment operator
    */
   G_API_GENEVA const GCheckCombinerT<ind_type>& operator=(const GCheckCombinerT<ind_type>& cp)  {
    ...
    */
   G_API_GENEVA bool operator==(const GCheckCombinerT<ind_type>& cp) const {
      using namespace Gem::Common;
      // Means: The expectation of equality was fulfilled, if no error text was emitted (which converts to "true")
    ...
    */
   G_API_GENEVA void setCombinerPolicy(validityCheckCombinerPolicy combinerPolicy) {
    ...
    */
   G_API_GENEVA validityCheckCombinerPolicy getCombinerPolicy() const {
...
protected:
    ...
    * MIN- or MAX_DOUBLE.
    */
   virtual G_API_GENEVA double check_(const ind_type *cp) const {
