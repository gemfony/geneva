...
BOOST_FUSION_ADAPT_STRUCT(
    ...
    (Gem::Geneva::NAMEANDIDTYPE, var)(bool, lowerBoundary)(bool, upperBoundary)(std::size_t, nSteps)
)

/** @brief Makes the struct boost.fusion-compatible */
BOOST_FUSION_ADAPT_STRUCT(Gem::Geneva::simpleScanSpec, (std::size_t, nItems))
