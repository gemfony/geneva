...
public:
   ...
   bool operator==(const GConstrainedNumCollectionT<num_type>& cp) const {
      ...
      return !checkRelationshipWith(cp, CE_EQUALITY, 0.,"GConstrainedNumCollectionT<num_type>::operator==","cp", CE_SILENT);
   }
   ...
   bool operator!=(const GConstrainedNumCollectionT<num_type>& cp) const {
      ...
      return !checkRelationshipWith(cp, CE_INEQUALITY, 0.,"GConstrainedNumCollectionT<num_type>::operator==","cp", CE_SILENT);
   }
   ...
   virtual void compare(
      ...
      try {
         // Check our parent class'es data ...
         GParameterCollectionT<num_type>::compare(cp, e, limit);
         ...
         g.add("g_expectation_violation caught by GParameterCollectionT<num_type>");
         throw g;
      }
   }
...
public:
   ...
   condnotset("GConstrainedNumCollectionT<>::modify_GUnitTests", "GEM_TESTING");
   return false;
#endif /* GEM_TESTING */
	}
...
#else /* GEM_TESTING */ // If this function is called when GEM_TESTING isn't set, throw
   condnotset("GConstrainedNumCollectionT<>::specificTestsNoFailureExpected_GUnitTests", "GEM_TESTING");
#endif /* GEM_TESTING */
	}
...
#else /* GEM_TESTING */ // If this function is called when GEM_TESTING isn't set, throw
   condnotset("GConstrainedNumCollectionT<>::specificTestsFailuresExpected_GUnitTests", "GEM_TESTING");
#endif /* GEM_TESTING */
	}
