	...
	:public GOptimizationAlgorithmT<GIndividual>
{
	...
	void serialize(Archive & ar, const unsigned int) {
		...
		ar & make_nvp("GOptimizationAlgorithmT_GIndividual", boost::serialization::base_object<GOptimizationAlgorithmT<GIndividual> >(*this))
		   ...
		   & BOOST_SERIALIZATION_NVP(parallelizationMode_);
	}
	///////////////////////////////////////////////////////////////////////
...
public:
	...
	/** @brief Allows to specify the parallelization mode to be used */
	void setParallelizationMode(parMode);
	/** @brief Allows to retrieve the current parallelization mode */
...
private:
	...
	parMode parallelizationMode_; ///< Indicates whether we use seria, multi-threaded or broker mode
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(Gem::Geneva::GEvolutionaryAlgorithm)
