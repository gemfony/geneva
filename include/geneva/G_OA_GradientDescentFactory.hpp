/**
 * @file G_OA_GradientDescentFactory.hpp
 */
...
public:
	 ...
	 G_API_GENEVA GGradientDescentFactory2(const GGradientDescentFactory2&);
	 /** @brief The destructor */
	 virtual G_API_GENEVA ~GGradientDescentFactory2();
