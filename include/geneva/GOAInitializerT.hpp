...
class GOAInitializerT {
	...
	static_assert(
		std::is_base_of<GOptimizationAlgorithmFactoryT<GOptimizationAlgorithmT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>> , oaf_type>::value
		, "GOptimizationAlgorithmFactoryT<GOptimizationAlgorithmT<Gem::Courtier::GBrokerExecutorT<GParameterSet>> is no base of oaf_type"
	);
...
public:
	...
	inline GOAInitializerT() {
		...
		std::shared_ptr<GOptimizationAlgorithmFactoryT<GOptimizationAlgorithmT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>>> p(new oaf_type());
