...
public:
	...
	G_API GMultiThreadedEA();
	/** @brief A standard copy constructor */
	G_API GMultiThreadedEA(const GMultiThreadedEA&);
	/** @brief The standard destructor */
	virtual G_API ~GMultiThreadedEA();

	/** @brief Assignment operator */
	G_API const GMultiThreadedEA& operator=(const GMultiThreadedEA&);

	/** @brief Checks for equality with another GMultiThreadedEA object */
	G_API bool operator==(const GMultiThreadedEA&) const;
