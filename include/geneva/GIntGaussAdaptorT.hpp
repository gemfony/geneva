...
public:
	 ...
	 */
	G_API_GENEVA GIntGaussAdaptorT()
	 ...
	 */
	G_API_GENEVA GIntGaussAdaptorT(const GIntGaussAdaptorT<int_type>& cp)
	 ...
	 */
	explicit G_API_GENEVA GIntGaussAdaptorT(const double& adProb)
	 ...
	 * The destructor
	 */
	virtual G_API_GENEVA ~GIntGaussAdaptorT()
	{ /* nothing */ }
