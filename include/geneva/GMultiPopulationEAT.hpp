...
public:
    ...
    */
   G_API GMultiPopulationEAT(const uint16_t& nThreads)
      : GBaseParChildT<oa_type>()
      , smodeMP_(DEFAULTSMODEMP)
    ...
    */
   G_API GMultiPopulationEAT(const GMultiPopulationEAT& cp)
    ...
    */
   virtual G_API ~GMultiPopulationEAT()
   { /* nothing */ }
    ...
    */
   G_API const GMultiPopulationEAT<oa_type>& operator=(const GMultiPopulationEAT<oa_type>& cp) {
    ...
    */
   G_API bool operator==(const GMultiPopulationEAT<oa_type>& cp) const {
    ...
    */
   virtual G_API void setSortingScheme(sortingModeMP smode) {
      smodeMP_=smode;
   }
    ...
    */
   G_API sortingModeMP getSortingScheme() const {
      return smodeMP_;
   }
    ...
    * "dirty flag" set.
    */
   G_API void addCleanStoredBests(
      GParameterSetFixedSizePriorityQueue& bestIndividuals
   ) OVERRIDE {
      const bool CLONE = true;
