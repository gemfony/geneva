...
using goa_factory = Gem::Geneva::GOptimizationAlgorithmFactoryT<Gem::Geneva::G_OptimizationAlgorithm_BaseT<Gem::Courtier::GBrokerExecutorT<Gem::Geneva::GParameterSet>>>;
