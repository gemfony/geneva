...
public:
	 ...
	 */
	G_API_GENEVA GFPGaussAdaptorT(const GFPGaussAdaptorT<fp_type>& cp)
	 ...
	 */
	explicit G_API_GENEVA GFPGaussAdaptorT(const double& adProb)
	 ...
	 * The destructor
	 */
	virtual G_API_GENEVA ~GFPGaussAdaptorT()
	{ /* nothing */ }
