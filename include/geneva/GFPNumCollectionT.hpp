...
public:
	 ...
	 void specificTestsFailuresExpected_GUnitTests() override {
		 ...
		 { // Check that adding another object of different size throws
			 ...
			 BOOST_CHECK_THROW(p_test1->GParameterBase::template add<fp_type>(p_test2, activityMode::ALLPARAMETERS), gemfony_exception);
		 }
		 ...
		 { // Check that subtracting another object of different size throws
			 ...
			 BOOST_CHECK_THROW(p_test1->GParameterBase::template subtract<fp_type>(p_test2, activityMode::ALLPARAMETERS), gemfony_exception);
		 }
