	 ...
	 virtual void customAdaptAdaption(const num_type&) override {
		 ...
		 sigma1_ *= gexp(
			 GAdaptorT<num_type>::m_normal_distribution(
				 GRANDOM_TLS
				 , typename std::normal_distribution<fp_type>::param_type(0., gfabs(sigmaSigma1_))
			 )
		 );
		 sigma2_ *= gexp(
			 GAdaptorT<num_type>::m_normal_distribution(
				 GRANDOM_TLS
				 , typename std::normal_distribution<fp_type>::param_type(0., gfabs(sigmaSigma2_))
			 )
		 );
		 delta_  *= gexp(
			 GAdaptorT<num_type>::m_normal_distribution(
				 GRANDOM_TLS
				 , typename std::normal_distribution<fp_type>::param_type(0., gfabs(sigmaDelta_))
			 )
		 );
