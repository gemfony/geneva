  ...
  : public GFPNumCollectionT<double> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            boost::serialization::base_object<GFPNumCollectionT<double>>(*this)
        );
    }
    ///////////////////////////////////////////////////////////////////////
...
public:
    ...
    GDoubleCollection() = default;
    /** @brief The copy constructor */
    GDoubleCollection(const GDoubleCollection &) = default;
    ...
    GDoubleCollection(const std::size_t &, const double &, const double &, const double &);
    /** @brief The destructor */
    ~GDoubleCollection() override = default;
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GDoubleCollection) // NOLINT
