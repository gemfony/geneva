...
protected:
    ...
    void customAdaptions(bool &, const bool &, Gem::Hap::GRandomBase &) override;
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GBooleanAdaptor) // NOLINT
