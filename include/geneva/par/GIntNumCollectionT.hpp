...
template <typename int_type>
struct is_abstract<Gem::Geneva::Parameters::GIntNumCollectionT<int_type>> : public boost::true_type {};
template <typename int_type>
struct is_abstract<const Gem::Geneva::Parameters::GIntNumCollectionT<int_type>> : public boost::true_type {};
} /* namespace boost::serialization */
/******************************************************************************/
