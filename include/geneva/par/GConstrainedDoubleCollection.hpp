...
/******************************************************************************/
/**
 * As Gem::Geneva::Parameters::GConstrainedDoubleCollection has a private default constructor, we need to provide a
...
TFactory_GUnitTests<Gem::Geneva::Parameters::GConstrainedDoubleCollection>() {
    ...
    CHECK_NOTHROW(
        p = std::make_shared<Gem::Geneva::Parameters::GConstrainedDoubleCollection>(
            nparameters,
            lowerboundary,
            upperboundary
        )
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GConstrainedDoubleCollection) // NOLINT
/******************************************************************************/
