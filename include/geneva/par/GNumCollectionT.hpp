...
protected:
     ...
     *
     * @param cp A copy of another GNumCollectionT<num_type> object, camouflaged as a GParameterBase
     */
    void load_(const GParameterBase *cp) override {
        ...
        const GNumCollectionT<num_type> *p_load =
            Gem::Common::g_convert_and_compare<GParameterBase, GNumCollectionT<num_type>>(cp, this);
