...
#include "geneva/par/GIntGaussAdaptorT.hpp"
...
public:
    ...
    GInt32GaussAdaptor(const GInt32GaussAdaptor &) = default;
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GInt32GaussAdaptor) // NOLINT
