...
public:
	...
	G_API GInt32ObjectCollection();
	/** @brief Initialization with a number of GInt32Object objects */
	G_API GInt32ObjectCollection(const std::size_t&, boost::shared_ptr<GInt32Object>);
	/** @brief The copy constructor */
	G_API GInt32ObjectCollection(const GInt32ObjectCollection&);
	/** @brief The destructor */
	virtual G_API ~GInt32ObjectCollection();

	/** @brief A standard assignment operator */
	G_API const GInt32ObjectCollection& operator=(const GInt32ObjectCollection&);

	/** @brief Checks for equality with another GInt32ObjectCollection object */
	G_API bool operator==(const GInt32ObjectCollection&) const;
