...
public:
   ...
   G_API GParameterBase();
	/** @brief The copy constructor */
   G_API GParameterBase(const GParameterBase&);
	/** @brief The standard destructor */
	virtual G_API ~GParameterBase();

	/** @brief The adaption interface */
	virtual G_API std::size_t adapt() OVERRIDE;
	/** @brief The actual adaption logic */
	virtual G_API std::size_t adaptImpl() BASE = 0;

   /** @brief Triggers updates when the optimization process has stalled */
   virtual G_API bool updateAdaptorsOnStall(const std::size_t&) BASE = 0;
   ...
   virtual G_API void toPropertyTree(pt::ptree&, const std::string&) const = 0;
   /** @brief Lets the audience know whether this is a leaf or a branch object */
   virtual G_API bool isLeaf() const BASE;

	/** @brief Assigns a random number generator from another object. */
	virtual G_API void assignGRandomPointer(Gem::Hap::GRandomBase *);
	...
	G_API boost::shared_ptr<load_type> parameterbase_cast (
...
protected:
   ...
   virtual G_API std::size_t countFloatParameters(const activityMode& am) const BASE;
   /** @brief Count the number of double parameters */
   virtual G_API std::size_t countDoubleParameters(const activityMode& am) const BASE;
   /** @brief Count the number of boost::int32_t parameters */
   virtual G_API std::size_t countInt32Parameters(const activityMode& am) const BASE;
   /** @brief Count the number of bool parameters */
   virtual G_API std::size_t countBoolParameters(const activityMode& am) const BASE;

   /** @brief Attach boundaries of type float to the vectors */
   virtual G_API void floatBoundaries(std::vector<float>&, std::vector<float>&, const activityMode&) const BASE;
   /** @brief Attach boundaries of type double to the vectors */
   virtual G_API void doubleBoundaries(std::vector<double>&, std::vector<double>&, const activityMode&) const BASE;
   /** @brief Attach boundaries of type boost::int32_t to the vectors */
   virtual G_API void int32Boundaries(std::vector<boost::int32_t>&, std::vector<boost::int32_t>&, const activityMode&) const BASE;
   /** @brief Attach boundaries of type bool to the vectors */
   virtual G_API void booleanBoundaries(std::vector<bool>&, std::vector<bool>&, const activityMode&) const BASE;

   /** @brief Attach parameters of type float to the vector */
   virtual G_API void floatStreamline(std::vector<float>&, const activityMode&) const BASE;
   /** @brief Attach parameters of type double to the vector */
   virtual G_API void doubleStreamline(std::vector<double>&, const activityMode&) const BASE;
   /** @brief Attach parameters of type boost::int32_t to the vector */
   virtual G_API void int32Streamline(std::vector<boost::int32_t>&, const activityMode&) const BASE;
   /** @brief Attach parameters of type bool to the vector */
   virtual G_API void booleanStreamline(std::vector<bool>&, const activityMode&) const BASE;

   /** @brief Attach parameters of type float to the map */
   virtual G_API void floatStreamline(std::map<std::string, std::vector<float> >&, const activityMode&) const BASE;
   /** @brief Attach parameters of type double to the map */
   virtual G_API void doubleStreamline(std::map<std::string, std::vector<double> >&, const activityMode&) const BASE;
   /** @brief Attach parameters of type boost::int32_t to the map */
   virtual G_API void int32Streamline(std::map<std::string, std::vector<boost::int32_t> >&, const activityMode&) const BASE;
   /** @brief Attach parameters of type bool to the map */
   virtual G_API void booleanStreamline(std::map<std::string, std::vector<bool> >&, const activityMode&) const BASE;

   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignFloatValueVector(const std::vector<float>&, std::size_t&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignDoubleValueVector(const std::vector<double>&, std::size_t&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignInt32ValueVector(const std::vector<boost::int32_t>&, std::size_t&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignBooleanValueVector(const std::vector<bool>&, std::size_t&, const activityMode&) BASE;

   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignFloatValueVectors(const std::map<std::string, std::vector<float> >&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignDoubleValueVectors(const std::map<std::string, std::vector<double> >&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignInt32ValueVectors(const std::map<std::string, std::vector<boost::int32_t> >&, const activityMode&) BASE;
   /** @brief Assigns part of a value vector to the parameter */
   virtual G_API void assignBooleanValueVectors(const std::map<std::string, std::vector<bool> >&, const activityMode&) BASE;

   /** @brief Multiplication with a random value in a given range */
   virtual G_API void floatMultiplyByRandom(const float& min, const float& max, const activityMode& am) BASE;
   /** @brief Multiplication with a random value in a given range */
   virtual G_API void doubleMultiplyByRandom(const double& min, const double& max, const activityMode& am) BASE;
   /** @brief Multiplication with a random value in a given range */
   virtual G_API void int32MultiplyByRandom(const boost::int32_t& min, const boost::int32_t& max, const activityMode& am) BASE;
   /** @brief Multiplication with a random value in a given range */
   virtual G_API void booleanMultiplyByRandom(const bool& min, const bool& max, const activityMode& am) BASE;

   /** @brief Multiplication with a random value in the range [0,1[ */
   virtual G_API void floatMultiplyByRandom(const activityMode& am) BASE;
   /** @brief Multiplication with a random value in the range [0,1[ */
   virtual G_API void doubleMultiplyByRandom(const activityMode& am) BASE;
   /** @brief Multiplication with a random value in the range [0,1[ */
   virtual G_API void int32MultiplyByRandom(const activityMode& am) BASE;
   /** @brief Multiplication with a random value in the range [0,1[ */
   virtual G_API void booleanMultiplyByRandom(const activityMode& am) BASE;

   /** @brief Multiplication with a constant value */
   virtual G_API void floatMultiplyBy(const float& value, const activityMode& am) BASE;
   /** @brief Multiplication with a constant value */
   virtual G_API void doubleMultiplyBy(const double& value, const activityMode& am) BASE;
   /** @brief Multiplication with a constant value */
   virtual G_API void int32MultiplyBy(const boost::int32_t& value, const activityMode& am) BASE;
   /** @brief Multiplication with a random value in the range [0,1[ */
   virtual G_API void booleanMultiplyBy(const bool& value, const activityMode& am) BASE;

   /** @brief Initialization with a constant value */
   virtual G_API void floatFixedValueInit(const float& value, const activityMode& am) BASE;
   /** @brief Initialization with a constant value */
   virtual G_API void doubleFixedValueInit(const double& value, const activityMode& am) BASE;
   /** @brief Initialization with a constant value */
   virtual G_API void int32FixedValueInit(const boost::int32_t& value, const activityMode& am) BASE;
   /** @brief Initialization with a random value in the range [0,1[ */
   virtual G_API void booleanFixedValueInit(const bool& value, const activityMode& am) BASE;

   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void floatAdd(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void doubleAdd(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void int32Add(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void booleanAdd(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;

   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void floatSubtract(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void doubleSubtract(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void int32Subtract(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
   /** @brief Adds the "same-type" parameters of another GParameterBase object to this one */
   virtual G_API void booleanSubtract(boost::shared_ptr<GParameterBase>, const activityMode& am) BASE;
	...
	/** @brief Triggers random initialization of the parameter(-collection) */
	virtual G_API void randomInit_(const activityMode&) BASE = 0;
 ...
 */
template <>
inline G_API  void GParameterBase::streamline<float>(
 ...
 */
template <>
inline G_API  void GParameterBase::streamline<double>(
 ...
 */
template <>
inline G_API  void GParameterBase::streamline<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::streamline<bool>(
 ...
 */
template <>
inline G_API  void GParameterBase::boundaries<float>(
 ...
 */
template <>
inline G_API  void GParameterBase::boundaries<double>(
 ...
 */
template <>
inline G_API  void GParameterBase::boundaries<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::boundaries<bool>(
 ...
 */
template <>
inline G_API  std::size_t GParameterBase::countParameters<float>(
   const activityMode& am
) const {
   if(
      this->modifiableAmMatchOrHandover(am)
 ...
 */
template <>
inline G_API  std::size_t GParameterBase::countParameters<double>(
   const activityMode& am
) const {
   if(
      this->modifiableAmMatchOrHandover(am)
 ...
 */
template <>
inline G_API  std::size_t GParameterBase::countParameters<boost::int32_t>(
   const activityMode& am
) const {
   if(
      this->modifiableAmMatchOrHandover(am)
 ...
 */
template <>
inline G_API  std::size_t GParameterBase::countParameters<bool>(
   const activityMode& am
) const {
   if(
      this->modifiableAmMatchOrHandover(am)
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVector<float>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVector<double>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVector<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVector<bool>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVectors<float>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVectors<double>(
   const std::map<std::string
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVectors<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::assignValueVectors<bool>(
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyByRandom<float>(
   const float& min
   , const float& max
   , const activityMode& am
) {
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyByRandom<double>(
   const double& min
   , const double& max
   , const activityMode& am
) {
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyByRandom<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyByRandom<bool>(
   const bool& min
   , const bool& max
   , const activityMode& am
) {
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyBy<float>(
   const float& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyBy<double>(
   const double& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyBy<boost::int32_t>(
 ...
 */
template <>
inline G_API  void GParameterBase::multiplyBy<bool>(
   const bool& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::fixedValueInit<float>(
   const float& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::fixedValueInit<double>(
   const double& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::fixedValueInit<boost::int32_t>(
   const boost::int32_t& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::fixedValueInit<bool>(
   const bool& val
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::add<float>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::add<double>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::add<boost::int32_t>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::add<bool>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::subtract<float>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::subtract<double>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::subtract<boost::int32_t>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
 ...
 */
template <>
inline G_API  void GParameterBase::subtract<bool>(
   boost::shared_ptr<GParameterBase> p
   , const activityMode& am
) {
   if(
