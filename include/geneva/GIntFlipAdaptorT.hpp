...
public:
	 ...
	 */
	explicit G_API GIntFlipAdaptorT(const double& prob)
	 ...
	 */
	G_API GIntFlipAdaptorT(const GIntFlipAdaptorT<int_type>& cp)
	 ...
	 * allocated data.
	 */
	virtual G_API ~GIntFlipAdaptorT()
	{ /* nothing */ }
