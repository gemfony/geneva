...
public:
	 ...
	 */
	explicit G_API_GENEVA GIntFlipAdaptorT(const double& prob)
	 ...
	 */
	G_API_GENEVA GIntFlipAdaptorT(const GIntFlipAdaptorT<int_type>& cp)
	 ...
	 * allocated data.
	 */
	virtual G_API_GENEVA ~GIntFlipAdaptorT()
	{ /* nothing */ }
