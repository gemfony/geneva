...
public:
	 ...
	 */
	G_API_GENEVA GOptimizationAlgorithmT()
	 ...
	 */
	G_API_GENEVA GOptimizationAlgorithmT(const GOptimizationAlgorithmT<ind_type>& cp)
	 ...
	 * The destructor
	 */
	virtual G_API_GENEVA ~GOptimizationAlgorithmT()
	{ /* nothing */ }
	 ...
	 */
	G_API_GENEVA void checkpoint(const bool& better) const {
	...
	virtual G_API_GENEVA void loadCheckpoint(const boost::filesystem::path&) = 0;
	 ...
	 */
	G_API_GENEVA void setCheckpointInterval(boost::int32_t cpInterval) {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getCheckpointInterval() const {
		return cpInterval_;
	}
	 ...
	 */
	G_API_GENEVA bool operator==(const GOptimizationAlgorithmT<ind_type>& cp) const {
	 ...
	 */
	virtual G_API_GENEVA void optimize(const boost::uint32_t& offset) OVERRIDE {
	 ...
	 */
	virtual G_API_GENEVA void optimize() OVERRIDE {
	 ...
	 */
	virtual G_API_GENEVA void doInfo(const infoMode& im) BASE {
#ifdef DEBUG
    ...
    */
	 ...
	 */
	G_API_GENEVA void registerOptimizationMonitor(boost::shared_ptr<typename GOptimizationAlgorithmT<ind_type>::GOptimizationMonitorT> om_ptr) {
#ifdef DEBUG
		if(!om_ptr) {
		   glogger
	 ...
	 */
	G_API_GENEVA void setMaxIteration(boost::uint32_t maxIteration) {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getMaxIteration() const {
	 ...
	 */
	G_API_GENEVA void setMaxStallIteration(boost::uint32_t maxStallIteration) {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getMaxStallIteration() const {
	 ...
	 */
	G_API_GENEVA void setMaxTime(boost::posix_time::time_duration maxDuration) {
	 ...
	 */
	G_API_GENEVA boost::posix_time::time_duration getMaxTime() const {
		return maxDuration_;
	}
	 ...
	 */
	G_API_GENEVA void setQualityThreshold(double qualityThreshold, bool hasQualityThreshold = true) {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getIteration() const {
		return iteration_;
	}
	 ...
	 */
	G_API_GENEVA boost::uint32_t getStartIteration() const {
		return offset_;
	}
	 ...
	 */
	G_API_GENEVA void setReportIteration(boost::uint32_t iter) {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getReportIteration() const {
	 ...
	 */
	G_API_GENEVA boost::uint32_t getStallCounter() const {
	 ...
	 */
	G_API_GENEVA void setStallCounterThreshold(boost::uint32_t stallCounterThreshold) {
	 ...
	 * individuals are asked to update their internal data structures
	 */
	G_API_GENEVA boost::uint32_t getStallCounterThreshold() const {
	 ...
	 */
	G_API_GENEVA boost::tuple<double, double> getBestCurrentPrimaryFitness() const {
	...
	G_API_GENEVA boost::shared_ptr<target_type> individual_cast(
	 ...
	 */
	virtual G_API_GENEVA void randomInit(const activityMode&) OVERRIDE { /* nothing */ }
	 ...
	 */
	virtual G_API_GENEVA std::size_t getNProcessableItems() const {
		return this->size();
	}
	 ...
	 */
	G_API_GENEVA boost::shared_ptr<typename GOptimizationAlgorithmT<ind_type>::GOptimizationMonitorT> getOptimizationMonitor() {
    ...
    */
   virtual G_API_GENEVA void addIterationBests(GParameterSetFixedSizePriorityQueue& bestIndividuals) BASE {
      glogger
    ...
    * "dirty flag" set.
    */
   virtual G_API_GENEVA void addCleanStoredBests(GParameterSetFixedSizePriorityQueue& bestIndividuals) BASE {
      glogger
   ...
   virtual G_API_GENEVA std::string name() const = 0;
    ...
    */
   virtual G_API_GENEVA bool isBetter(double newValue, const double& oldValue) const OVERRIDE {
#ifdef DEBUG
      if(this->empty()) {
         glogger
    ...
    */
   virtual G_API_GENEVA bool isWorse(double newValue, const double& oldValue) const OVERRIDE {
#ifdef DEBUG
      if(this->empty()) {
         glogger
    ...
    */
   virtual G_API_GENEVA double getWorstCase() const OVERRIDE {
#ifdef DEBUG
      if(this->empty()) {
         glogger
    ...
    * in maximization or minimization mode
    */
   virtual G_API_GENEVA double getBestCase() const OVERRIDE {
#ifdef DEBUG
      if(this->empty()) {
         glogger
...
protected:
   ...
   virtual G_API_GENEVA std::vector<boost::shared_ptr<GParameterSet> > customGetBestIndividuals() OVERRIDE {
	 ...
	 */
	virtual G_API_GENEVA void setIndividualPersonalities() {
	...
	virtual G_API_GENEVA void saveCheckpoint() const = 0;

	/***************************************************************************/
	/** @brief The actual business logic to be performed during each iteration */
	virtual G_API_GENEVA boost::tuple<double, double> cycleLogic() BASE = 0;
   ...
   virtual G_API_GENEVA boost::shared_ptr<GPersonalityTraits> getPersonalityTraits() const = 0;
	 ...
	 * cycle.
	 */
	virtual G_API_GENEVA void markIteration() BASE {
      typename GOptimizationAlgorithmT<ind_type>::iterator it;
		for(it=this->begin(); it!=this->end(); ++it) {
...
public:
	...
	public:
	     ...
	     * The default constructor
	     */
	    G_API_GENEVA GOptimizationMonitorT()
	    	: GObject()
	    	, quiet_(false)
	    { /* nothing */ }
	     ...
	     * The destructor
	     */
	    virtual G_API_GENEVA ~GOptimizationMonitorT()
	    { /* nothing */ }
	     ...
	     */
	    G_API_GENEVA const GOptimizationMonitorT& operator=(
         const typename GOptimizationAlgorithmT<ind_type>::GOptimizationMonitorT& cp
       ) {
	     ...
	     * @return A boolean indicating whether both objects are equal
	     */
	    virtual G_API_GENEVA bool operator==(const typename GOptimizationAlgorithmT<ind_type>::GOptimizationMonitorT& cp) const {
	    	using namespace Gem::Common;
	    	// Means: The expectation of equality was fulfilled, if no error text was emitted (which converts to "true")
	     ...
	     */
	    G_API_GENEVA void preventInformationEmission() {
	    	quiet_ = true;
	    }
	     ...
	     */
	    G_API_GENEVA void allowInformationEmission() {
	    	quiet_ = false;
	    }
	     ...
	     */
	    G_API_GENEVA bool informationEmissionPrevented() const {
	    	return quiet_;
	    }
	     ...
	     */
	    G_API_GENEVA void registerPluggableOM(boost::function<void(const infoMode&, GOptimizationAlgorithmT<ind_type> * const)> pluggableInfoFunction) {
	...
	protected:
	     ...
	     * @param goa A pointer to the current optimization algorithm for which information should be emitted
	     */
	    virtual G_API_GENEVA void firstInformation(GOptimizationAlgorithmT<ind_type> * const goa) BASE
	    { /* nothing */ }
	     ...
	     * @param goa A pointer to the current optimization algorithm for which information should be emitted
	     */
	    virtual G_API_GENEVA void cycleInformation(GOptimizationAlgorithmT<ind_type> * const goa) BASE
	    { /* nothing */ }
	     ...
	     * @param goa A pointer to the current optimization algorithm for which information should be emitted
	     */
	    virtual G_API_GENEVA void lastInformation(GOptimizationAlgorithmT<ind_type> * const goa) BASE
	    { /* nothing */ }
 ...
 */
template <>
inline G_API_GENEVA void GOptimizationAlgorithmT<Gem::Geneva::GParameterSet>::init(){
 ...
 */
template <>
inline G_API_GENEVA void GOptimizationAlgorithmT<Gem::Geneva::GParameterSet>::addIterationBests(
 ...
 */
template <>
inline G_API_GENEVA void GOptimizationAlgorithmT<Gem::Geneva::GParameterSet>::addCleanStoredBests(
   GParameterSetFixedSizePriorityQueue& bestIndividuals
) {
   const bool CLONE = true;
 ...
 */
template <>
inline G_API_GENEVA void GOptimizationAlgorithmT<Gem::Geneva::GParameterSet>::finalize() {
