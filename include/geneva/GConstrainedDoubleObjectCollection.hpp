...
public:
	...
	G_API GConstrainedDoubleObjectCollection();
	/** @brief Initialization with a number of GConstrainedDoubleObject objects */
	G_API GConstrainedDoubleObjectCollection(const std::size_t&, boost::shared_ptr<GConstrainedDoubleObject>);
	/** @brief The copy constructor */
	G_API GConstrainedDoubleObjectCollection(const GConstrainedDoubleObjectCollection&);
	/** @brief The destructor */
	virtual G_API ~GConstrainedDoubleObjectCollection();

	/** @brief A standard assignment operator */
	G_API const GConstrainedDoubleObjectCollection& operator=(const GConstrainedDoubleObjectCollection&);

	/** @brief Checks for equality with another GConstrainedDoubleObjectCollection object */
	G_API bool operator==(const GConstrainedDoubleObjectCollection&) const;
