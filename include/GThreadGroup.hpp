...
namespace GenEvA
{
   ...
   */
  class GThreadGroup : private noncopyable
  {
  ...
  public:
     ...
     * As we are using a vector of shared_ptr<thread> objects, we do not have
    ...
    remove_last(void)
    {
      ...
      (threads_.back())->join();
      // shared_ptr takes care of the deltion of the thread object
      threads_.pop_back();
    }
