...
private:
	  ...
	  */
	 virtual void save_to(boost::property_tree::ptree &pt) const override {
...
private:
	  ...
	  */
	 virtual void save_to(boost::program_options::options_description &desc) const {
