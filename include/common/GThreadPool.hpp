 ...
 */
    ...
    public:
        ...
        auto async_schedule(
            F&& f
            , Args&&... args
            , typename std::enable_if<std::is_void<typename std::result_of<F(Args...)>::type>::value>::type* dummy =
                nullptr
        ) -> std::future<typename std::result_of<F(Args...)>::type>
        {
            ...
            if (not m_threads_started)
            {
                ...
                if (not m_threads_started)
                {
                    ...
                    m_work_guard_ptr = std::make_shared<boost::asio::executor_work_guard<
        ...
        auto async_schedule(
            F&& f
            , Args&&... args
            , typename std::enable_if<not std::is_void<typename std::result_of<F(Args...)>::type>::value>::type* dummy =
                nullptr
        ) -> std::future<typename std::result_of<F(Args...)>::type>
        {
            // We may only submit new jobs if job_lck can be acquired. This is important
    ...
    private:
        ...
        std::shared_ptr<boost::asio::executor_work_guard<boost::asio::io_context::executor_type>> m_work_guard_ptr;
