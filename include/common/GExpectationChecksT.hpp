...
G_API_COMMON
void compare(
	const boost::logic::tribool &, const boost::logic::tribool &, const std::string &, const std::string &,
	const Gem::Common::expectation &, const double &limit = CE_DEF_SIMILARITY_DIFFERENCE
);
