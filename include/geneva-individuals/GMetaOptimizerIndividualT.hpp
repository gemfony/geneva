...
class GOptOptMonitorT
	: public GBasePluggableOM<G_OptimizationAlgorithm_Base>
{
	 ...
	 void serialize(Archive & ar, const unsigned int){
		 ...
		 ar
		 & make_nvp("GBasePluggableOM",	boost::serialization::base_object<GBasePluggableOM<G_OptimizationAlgorithm_Base>>(*this))
...
public:
	 ...
	 GOptOptMonitorT(const GOptOptMonitorT<ind_type> &cp)
		 : GBasePluggableOM<G_OptimizationAlgorithm_Base>(cp)
	 ...
	 virtual void compare(
		 ...
		 // Compare our parent data ...
		 Gem::Common::compare_base<GBasePluggableOM<G_OptimizationAlgorithm_Base>>(IDENTITY(*this, *p_load), token);
...
protected:
	 ...
	 virtual void load_(const GObject *cp) override {
		 ...
		 GBasePluggableOM<G_OptimizationAlgorithm_Base>::load_(cp);
...
public:
	 ...
	 virtual bool modify_GUnitTests() override {
		 ...
		 // Call the parent classes' functions
		 if(GBasePluggableOM<G_OptimizationAlgorithm_Base>::modify_GUnitTests()) {
			 result = true;
		 }
	 ...
	 virtual void specificTestsNoFailureExpected_GUnitTests() override {
		 ...
		 // Call the parent classes' functions
		 GBasePluggableOM<G_OptimizationAlgorithm_Base>::specificTestsNoFailureExpected_GUnitTests();
#else /* GEM_TESTING */  // If this function is called when GEM_TESTING isn't set, throw
	 ...
	 virtual void specificTestsFailuresExpected_GUnitTests() override {
		 ...
		 // Call the parent classes' functions
		 GBasePluggableOM<G_OptimizationAlgorithm_Base>::specificTestsFailuresExpected_GUnitTests();
