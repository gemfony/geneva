  ...
  : public GParameterSet { // NOLINT(cppcoreguidelines-special-member-functions)
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &BOOST_SERIALIZATION_BASE_OBJECT_NVP(GParameterSet) &
            BOOST_SERIALIZATION_NVP(m_program_name) & BOOST_SERIALIZATION_NVP(m_custom_options) &
...
private:
    ...
    std::string
        m_custom_options; ///< Any custom options that need to be provided to the external program
  ...
  : public Gem::Common::GFactoryT<GParameterSet> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &BOOST_SERIALIZATION_BASE_OBJECT_NVP(GFactoryT<GParameterSet>) &
            BOOST_SERIALIZATION_NVP(m_adProb) & BOOST_SERIALIZATION_NVP(m_adaptAdProb) &
            BOOST_SERIALIZATION_NVP(m_minAdProb) & BOOST_SERIALIZATION_NVP(m_maxAdProb) &
            BOOST_SERIALIZATION_NVP(m_adaptionThreshold) &
            BOOST_SERIALIZATION_NVP(m_useBiGaussian) & BOOST_SERIALIZATION_NVP(m_sigma1) &
            BOOST_SERIALIZATION_NVP(m_sigmaSigma1) & BOOST_SERIALIZATION_NVP(m_minSigma1) &
            BOOST_SERIALIZATION_NVP(m_maxSigma1) & BOOST_SERIALIZATION_NVP(m_sigma2) &
            BOOST_SERIALIZATION_NVP(m_sigmaSigma2) & BOOST_SERIALIZATION_NVP(m_minSigma2) &
            BOOST_SERIALIZATION_NVP(m_maxSigma2) & BOOST_SERIALIZATION_NVP(m_delta) &
            BOOST_SERIALIZATION_NVP(m_sigmaDelta) & BOOST_SERIALIZATION_NVP(m_minDelta) &
            BOOST_SERIALIZATION_NVP(m_maxDelta) & BOOST_SERIALIZATION_NVP(m_programName) &
            ...
            BOOST_SERIALIZATION_NVP(m_externalEvaluatorQueried) & BOOST_SERIALIZATION_NVP(m_ptr);
    }
...
private:
    ...
    bool
        m_externalEvaluatorQueried; ///< Specifies whether the external evaluator program has already been queried for setup information
    pt::ptree
        m_ptr; ///< Holds setup information for individuals, as provided by the external evaluator program
};
