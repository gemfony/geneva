...
namespace Gem::Courtier
{
    ...
    private:
         ...
         */
        void processFinalize() { this->processFinalize_(); }
        ...
        retrieve(const std::chrono::milliseconds& timeout)
        {
         ...
         */
        void submit(std::shared_ptr<processable_type> item_ptr,
         ...
         */
        [[nodiscard]] bool stop_requested() const { return this->stop_requested_(); }

        /************************************************************************/
        /**
         * Setting of the total number of workers
         */
        void setNWorkers(std::size_t nWorkers) { nWorkers_ = nWorkers; }

        /************************************************************************/
        /**
         * Retrieve the total number of workers
         */
        std::size_t getNWorkers() const { return nWorkers_; }
    ...
    private:
        ...
        std::int32_t m_worker_id =
            -1; ///< The id of the thread running this class'es operator()
    ...
    public:
         ...
         */
        GBrokerFerryT(const std::size_t& worker_id,
                      std::function<std::shared_ptr<processable_type>(
                          const std::chrono::milliseconds&)>
                      retriever,
                      std::function<void(std::shared_ptr<processable_type>,
                                         const std::chrono::milliseconds&)>
                      submitter,
                      std::function<bool()> stop_requested)
            : m_worker_id(worker_id), m_retriever(retriever), m_submitter(submitter),
        ...
        GBrokerFerryT<processable_type>&
        operator=(const GBrokerFerryT<processable_type>&) = delete;
        GBrokerFerryT<processable_type>&
        operator=(GBrokerFerryT<processable_type>&&) = delete;
         ...
         * Indicates whether the worker was asked to stop processing
         */
        [[nodiscard]] bool stop_requested() const { return this->m_stop_requested(); }

        /************************************************************************/
        /**
         * Access to the worker id
         */
        [[nodiscard]] std::size_t getWorkerId() const { return m_worker_id; }
    ...
    private:
        ...
        /** @brief Retrieval of work items */
        std::shared_ptr<processable_type>
        retrieve_(const std::chrono::milliseconds& timeout) override
        {
        ...
        /************************************************************************/
        /** @brief Submission of work items */
        void submit_(std::shared_ptr<processable_type> p,
