 ...
 */
    ...
    class GBufferPortT
    {
        ...
        static_assert(
            std::is_base_of<GProcessingContainerT<
                                processable_type, typename processable_type::result_type>, processable_type>::value
        ...
        using RAW_BUFFER_TYPE = Common::GBoundedBufferT<
            std::shared_ptr<processable_type>, Common::DEFAULTBUFFERSIZE>;
