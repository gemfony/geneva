...
public:
	typedef initial_seed_type nondet_rng::result_type;
	typedef seed_type mersenne_twister::result_type;

	/** @brief The default constructor. */
	GSeedManager();
	/** @brief Initialization with a start seed */
	explicit GSeedManager(const initial_seed_type& startSeed, const std::size_t& seedQueueSize = DEFAULTQUEUESIZE);
...
private:
	...
	GBoundedBufferT<seed_type> seedQueue_;
