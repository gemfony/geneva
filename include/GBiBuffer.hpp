...
namespace GenEvA
{
  ...
  public:
     ...
     */
    explicit GBiBuffer(uint16_t size)
     ...
     */
    inline void push_front_orig(const T& item, uint16_t sec, uint16_t msec){
     ...
     * @param msec The millisecond-part of the maximum waiting time
     */
    inline void pop_back_orig(T *item, uint16_t sec, uint16_t msec){
     ...
     * @param msec The millisecond-part of the maximum waiting time
     */
    inline void push_front_processed(const T& item, uint16_t sec, uint16_t msec){
     ...
     * @param msec The millisecond-part of the maximum waiting time
     */
    inline void pop_back_processed(T* item, uint16_t sec, uint16_t msec){
  ...
  private:
    GBoundedBuffer<T> original_; ///< The queue for raw objects
    GBoundedBuffer<T> processed_; ///< The queue for processed objects
  };
