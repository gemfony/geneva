 ...
 */
class GBasePlotter : public Gem::Common::GBoilerplateBaseT<GBasePlotter, Gem::Common::GCommonInterfaceT<GBasePlotter>> {
    ///////////////////////////////////////////////////////////////////////
     ...
     * @return A tuple of named member references driving the GBoilerplateBaseT-generated serialize()/load_()/compare_()
     */
...
public:
    ...
    static constexpr std::string_view class_name = "GBasePlotter";
...
protected:
    // load_(), compare_() and name_() are generated by the Gem::Common::GBoilerplateBaseT
    // base from class_name and localMembers_(); clone_() stays pure (this is an abstract root).
