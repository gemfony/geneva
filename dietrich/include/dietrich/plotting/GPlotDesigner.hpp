 ...
 */
class GPlotDesigner
  : public Gem::Common::GBoilerplateT<GPlotDesigner, Gem::Common::GCommonInterfaceT<GPlotDesigner>, GPlotDesigner> {
    ///////////////////////////////////////////////////////////////////////
    // boost::serialization::access default-constructs this concrete type on load;
    // GBoilerplateAccess lets the GBoilerplateT base reach this class's private localMembers_().
     ...
     * GBoilerplateT-generated serialize()/load_()/compare_(). plotters_cnt_ (the plot
