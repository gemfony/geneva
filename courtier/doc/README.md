...
(broker / consumer parallelisation framework: `GBrokerT`, serial /
multi-threaded / Asio / Beast-websocket / MPI consumers, command-container
protocol, processing-container CRTP).
...
Reserved for future Courtier-library manuals (consumer protocol, broker
flow diagrams, MPI deployment notes, websocket security considerations).
