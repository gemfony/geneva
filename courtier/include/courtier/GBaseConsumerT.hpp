...
protected:
     ...
     *  clone functor when set (required for polymorphic item types such as GParameterTree, to avoid
...
public:
     ...
     *  item is a polymorphic base (e.g. GParameterTree holding a concrete individual): plain
