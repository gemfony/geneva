...
namespace Gem::Geneva
{
    ...
    void GMultiCriterionParabolaIndividual::load_(const GObject* cp)
    {
        ...
        const GMultiCriterionParabolaIndividual* p_load = Gem::Common::g_convert_and_compare<
            GObject, GMultiCriterionParabolaIndividual>(cp, this);
     ...
     */
    GMultiCriterionParabolaIndividualFactory::GMultiCriterionParabolaIndividualFactory(std::filesystem::path const& cF)
