 ...
 */
class GBeeColonyIndividual : public GParameterSet
{
...
public:
	 ...
	 GBeeColonyIndividual();
	 /** @brief A standard copy constructor */
	 GBeeColonyIndividual(const GBeeColonyIndividual&);
	 /** @brief The standard destructor */
	 virtual ~GBeeColonyIndividual();

protected:
	 /** @brief Loads the data of another GBeeColonyIndividual */
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::GBeeColonyIndividual)
