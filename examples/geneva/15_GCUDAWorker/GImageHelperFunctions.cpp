...
namespace Gem::Common
{
                      ...
                      int& outHeight)
    {
        ...
        for (int y = 0; y < height; y++)
        {
            std::memcpy(finalData + (y * width * 3),
     ...
     */
    bool writeRGBtoPNG(const std::string& filename,
     ...
     */
    bool loadImageToRGB(const std::string& fileName,
                        ...
                        int& height)
    {
        ...
        if (first)
        {
            ...
            if (suffix == "PNG" || suffix == "png")
            {
                ...
                {
                    std::cout << "Loading PNG image " << l_fileName << " from disc into RGB failed" << std::endl;
                    return false;
                }
                else
                {
                    std::cout << "Successfully loaded PNG image " << l_fileName << " from disc into RGB" << std::endl;
                }
            }
        }
        else
        {
            ...
            {
                std::cout << "Common::loadImageToRGB: Error. fileName ("
                    << fileName << ") and l_fileName (" << l_fileName << ") differ" << std::endl;
                return false;
            }
        }
