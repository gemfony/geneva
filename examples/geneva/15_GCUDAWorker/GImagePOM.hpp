...
public:
    ...
    GImagePOM(const GImagePOM &cp)
      ...
      , first_(true)
      , // will result in a seperate evaluatpr
      evaluator_ptr_{} {
        /* nothing */
    }
...
private:
        ...
        case Gem::Geneva::infoMode::INFOPROCESSING: {
            ...
            if(not emitBestOnly_ || goa->progress()) {
                const std::string resultFileName =
                    ...
                    std::to_string(goa->G_Interface_OptimizerT::getIteration()) + "_" +
    ...
    bool emitBestOnly_{
        true
    };                  ///< Indicates whether images should only be written for improved iterations
    ...
    std::shared_ptr<Geneva::GImageIndividualEvaluator>
        evaluator_ptr_; ///< Will point to the evaluator
};
