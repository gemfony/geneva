...
GStarterIndividual::GStarterIndividual(const std::size_t& prod_id,
    ...
    try {
        ...
        GStarterIndividual::addContent(*this,
                                       prod_id,
                                       startValues,
                                       lowerBoundaries,
                                       upperBoundaries,
 ...
 */
void GStarterIndividual::compare_(const GObject& cp,
...
void GStarterIndividual::specificTestsNoFailureExpected_GUnitTests_() {
...

    {
        ...
        BOOST_CHECK_NO_THROW(p_test = std::shared_ptr<GStarterIndividual>(
                                 new GStarterIndividual(0  // indicates the first individual
                                                        ,
                                                        startValues,
                                                        lowerBoundaries,
                                                        upperBoundaries,
...
void GStarterIndividualFactory::postProcess_(std::shared_ptr<GParameterSet>& p_base) {
    ...
    GStarterIndividual::addContent(*p,
                                   this->getId(),
                                   m_startValues,
                                   m_lowerBoundaries,
                                   m_upperBoundaries,
