 ...
 */
void GConjugateGradientDescent_PersonalityTraits::setPopulationPosition(const std::size_t &popPos) {
    popPos_ = popPos;
}
 ...
 */
std::size_t GConjugateGradientDescent_PersonalityTraits::getPopulationPosition(void) const {
    return popPos_;
}
