 ...
 */
std::shared_ptr<G_OptimizationAlgorithm_Base> GNelderMeadFactory::getObject_(
 ...
 */
void GNelderMeadFactory::postProcess_(std::shared_ptr<G_OptimizationAlgorithm_Base> &p_base) {
