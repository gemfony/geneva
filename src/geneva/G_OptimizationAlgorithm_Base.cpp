 ...
 */
bool GBasePluggableOM::operator==(const GBasePluggableOM& cp) const {
 ...
 * @return A boolean indicating whether both objects are equal
 */
bool G_OptimizationAlgorithm_Base::operator==(const G_OptimizationAlgorithm_Base& cp) const {
	using namespace Gem::Common;
	try {
 ...
 */
void G_OptimizationAlgorithm_Base::updateWorstKnownValid() {
 ...
 */
void G_OptimizationAlgorithm_Base::markWorstKnownValid() {
 ...
 */
void G_OptimizationAlgorithm_Base::triggerEvaluationUpdate() {
 ...
 */
void G_OptimizationAlgorithm_Base::postEvaluationWork() {
