...
GSwarmAlgorithm::GSwarmAlgorithm(
	...
	: G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>()
...
{
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::setDefaultPopulationSize(m_n_neighborhoods * m_default_n_neighborhood_members);
}
...
GSwarmAlgorithm::GSwarmAlgorithm(const GSwarmAlgorithm &cp)
	: G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>(cp)
...
void GSwarmAlgorithm::compare(
	...
	Gem::Common::compare_base<G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>>(IDENTITY(*this, *p_load), token);
...
void GSwarmAlgorithm::resetToOptimizationStart() {
	...
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::resetToOptimizationStart();
}
 ...
 * from within G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::optimize(), immediately before the actual optimization cycle starts.
 */
void GSwarmAlgorithm::init() {
	// To be performed before any other action
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::init();
   ...
   if(m_dbl_lower_parameter_boundaries_vec.size() != m_dbl_upper_parameter_boundaries_vec.size()) {
	...
	for(auto ind: *this) {
		...
		for (std::size_t i = 0; i < velVec.size(); i++) {
			...
			velVec[i] =
				G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(-range,range));
		}
...
void GSwarmAlgorithm::finalize() {
	...
	// Last action
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::finalize();
}
 ...
 * function is called by G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::optimize() for each iteration of
 * the optimization,
 *
	...
	switch (m_update_rule) {
		case updateRule::SWARM_UPDATERULE_CLASSIC:
			...
			for (std::size_t i = 0; i < personalBestVec.size(); i++) {
				personalBestVec[i] *= (cPersonal * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
				nbhBestVec[i] *= (cNeighborhood * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
				glbBestVec[i] *= (cGlobal * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
			}
			break;
		...
		case updateRule::SWARM_UPDATERULE_LINEAR:
			...
			Gem::Common::multVecConst<double>(personalBestVec, cPersonal * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
			Gem::Common::multVecConst<double>(nbhBestVec, cNeighborhood * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
			Gem::Common::multVecConst<double>(glbBestVec, cGlobal * G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::m_uniform_real_distribution(m_gr, std::uniform_real_distribution<double>::param_type(0.,1.)));
			break;
	}
 ...
 * the purely virtual function G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::adjustPopulation() .
 */
...
bool GSwarmAlgorithm::modify_GUnitTests() {
	...
	if (G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::modify_GUnitTests()) result = true;
...
#ifdef GEM_TESTING
	// Call the parent class'es function
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::specificTestsNoFailureExpected_GUnitTests();
...
#ifdef GEM_TESTING
	// Call the parent class'es function
	G_OA_BaseT<Gem::Courtier::GBrokerExecutorT<GParameterSet>>::specificTestsFailuresExpected_GUnitTests();
