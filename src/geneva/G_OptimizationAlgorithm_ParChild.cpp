...
void G_OptimizationAlgorithm_ParChild::compare_(
    ...
    const G_OptimizationAlgorithm_ParChild *p_load =
        Gem::Common::g_convert_and_compare<GObject, G_OptimizationAlgorithm_ParChild>(cp, this);
 ...
 */
void G_OptimizationAlgorithm_ParChild::addConfigurationOptions_(Gem::Common::GParserBuilder &gpb) {
