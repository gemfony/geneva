...
bool GCharObjectCollection::operator==(const GCharObjectCollection& cp) const {
	...
	return !checkRelationshipWith(cp, CE_EQUALITY, 0.,"GCharObjectCollection::operator==","cp", CE_SILENT);
}
...
bool GCharObjectCollection::operator!=(const GCharObjectCollection& cp) const {
	...
	return !checkRelationshipWith(cp, CE_INEQUALITY, 0.,"GCharObjectCollection::operator!=","cp", CE_SILENT);
}
 ...
 */
boost::optional<std::string> GCharObjectCollection::checkRelationshipWith(const GObject& cp,
		...
		const bool& withMessages) const
{
	...
	deviations.push_back(GParameterTCollectionT<GChar>::checkRelationshipWith(cp, e, limit, "GCharObjectCollection", y_name, withMessages));

	// no local data ...

	return evaluateDiscrepancies("GCharObjectCollection", caller, deviations, e);
}
 ...
 */
bool GCharObjectCollection::modify_GUnitTests() {
	bool result = false;

	// Call the parent class'es function
	if(GParameterTCollectionT<GChar>::modify_GUnitTests()) result = true;
 ...
 */
void GCharObjectCollection::specificTestsNoFailureExpected_GUnitTests() {
	// Call the parent class'es function
	GParameterTCollectionT<GChar>::specificTestsNoFailureExpected_GUnitTests();
}
 ...
 */
void GCharObjectCollection::specificTestsFailuresExpected_GUnitTests() {
	// Call the parent class'es function
	GParameterTCollectionT<GChar>::specificTestsFailuresExpected_GUnitTests();
}
