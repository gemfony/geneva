...
int main(int argc, char **argv) {
	...
	for(std::size_t s=1; s<=MAXOBJECTSIZE; s+=(s<10?1:STEPSIZE)) {
		...
		for(std::size_t o=0; o<NPERFOBJECTTYPES; o++) {
			...
			switch(o) {
			case 0:
				(*gdo_adapt_ptr) & boost::tuple<double,double>((double)s, adaptionTimeD);
				(*gdo_ser_ptr) & boost::tuple<double,double>((double)s, serializationTimeD);
				break;

			case 1:
				(*gcdo_adapt_ptr) & boost::tuple<double,double>((double)s, adaptionTimeD);
				(*gcdo_ser_ptr) & boost::tuple<double,double>((double)s, serializationTimeD);
				break;

			case 2:
				(*gcdoc_adapt_ptr) & boost::tuple<double,double>((double)s, adaptionTimeD);
				(*gcdoc_ser_ptr) & boost::tuple<double,double>((double)s, serializationTimeD);
				break;

			case 3:
				(*gdc_adapt_ptr) & boost::tuple<double,double>((double)s, adaptionTimeD);
				(*gdc_ser_ptr) & boost::tuple<double,double>((double)s, serializationTimeD);
				break;

			case 4:
				(*gcdc_adapt_ptr) & boost::tuple<double,double>((double)s, adaptionTimeD);
				(*gcdc_ser_ptr) & boost::tuple<double,double>((double)s, serializationTimeD);
				break;
