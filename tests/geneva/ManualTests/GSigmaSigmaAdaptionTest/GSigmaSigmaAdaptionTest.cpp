...
int main() {
	...
	for(std::size_t p=0; p<NPOINTS; p++) {
		...
		devel1_02_ptr->add(boost::tuple<double,double>(double(p), sigma_1_02));
		devel1_04_ptr->add(boost::tuple<double,double>(double(p), sigma_1_04));
		devel1_06_ptr->add(boost::tuple<double,double>(double(p), sigma_1_06));
		devel1_08_ptr->add(boost::tuple<double,double>(double(p), sigma_1_08));

		devel2_02_ptr->add(boost::tuple<double,double>(double(p), sigma_2_02));
		devel2_04_ptr->add(boost::tuple<double,double>(double(p), sigma_2_04));
		devel2_06_ptr->add(boost::tuple<double,double>(double(p), sigma_2_06));
		devel2_08_ptr->add(boost::tuple<double,double>(double(p), sigma_2_08));
	}
