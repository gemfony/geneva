...
int main(int argc, char **argv) {
    ...
    multipleFlipMutation_ptr->setPlotLabel(
        "Occurance of different values when flip-mutating, starting with 1"
    );
    ...
    multipleFlipProgress_ptr->setPlotLabel(
        "Current value of a GConstrainedInt32Object after repeated flip mutations"
    );
    ...
    multipleGaussMutation_ptr->setPlotLabel(
        "Occurance of different values when gauss-mutating, starting with 1"
    );
    ...
    multipleGaussProgress_ptr->setPlotLabel(
        "Current value of a GConstrainedInt32Object after repeated gauss mutations"
    );
