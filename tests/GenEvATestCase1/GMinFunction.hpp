...
namespace GenEvA
{
    ...
    :public GDoubleCollection
  {
    ...
    void serialize(Archive & ar, const unsigned int version){
      ...
      ar & make_nvp("GDoubleCollection",
		    boost::serialization::base_object<GDoubleCollection>(*this));
    }
    ///////////////////////////////////////////////////////////////////////

  public:
    GMinFunction(int16_t nval)
      :GDoubleCollection(nval)
    { /* nothing */ }

    GMinFunction(const GMinFunction& cp)
      :GDoubleCollection(cp)
    { /* nothing */ }
