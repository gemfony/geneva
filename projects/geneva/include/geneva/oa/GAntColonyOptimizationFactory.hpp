...
/******************************************************************************/
/**
 * @brief The factory that builds ant-colony optimization from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GAntColonyOptimization.json"), getMnemonic()
 ...
 */
using GAntColonyOptimizationFactory = GOptimizationAlgorithmFactoryT<GAntColonyOptimization, GAntColonyOptimization_PersonalityTraits>;
