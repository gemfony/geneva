...
/******************************************************************************/
/**
 * @brief The factory that builds the separable CMA evolution strategy from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GSepCmaEvolutionStrategy.json"), getMnemonic()
 ...
 */
using GSepCmaEvolutionStrategyFactory = GOptimizationAlgorithmFactoryT<GSepCmaEvolutionStrategy, GSepCmaEvolutionStrategy_PersonalityTraits>;
