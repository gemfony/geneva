...
/******************************************************************************/
/**
 * @brief The factory that builds simulated annealing from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GSimulatedAnnealing.json"), getMnemonic()
 ...
 */
using GSimulatedAnnealingFactory = GOptimizationAlgorithmFactoryT<GSimulatedAnnealing, GSimulatedAnnealing_PersonalityTraits>;
