...
/******************************************************************************/
/**
 * @brief The factory that builds swarm algorithms from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GSwarmAlgorithm.json"), getMnemonic()
 ...
 */
using GSwarmAlgorithmFactory = GOptimizationAlgorithmFactoryT<GSwarmAlgorithm, GSwarmAlgorithm_PersonalityTraits>;
