...
/******************************************************************************/
/**
 * @brief The factory that builds generalized simulated annealing from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GGeneralizedSimulatedAnnealing.json"), getMnemonic()
 ...
 */
using GGeneralizedSimulatedAnnealingFactory = GOptimizationAlgorithmFactoryT<GGeneralizedSimulatedAnnealing, GGeneralizedSimulatedAnnealing_PersonalityTraits>;
