...
/******************************************************************************/
/**
 * @brief The factory that builds the conjugate gradient descent from a configuration file.
 *
 * The GOptimizationAlgorithmFactoryT scaffold generates everything such a factory needs -- the three
 * constructors (the default one deriving the config path "./config/GConjugateGradientDescent.json"), getMnemonic()
 ...
 */
using GConjugateGradientDescentFactory = GOptimizationAlgorithmFactoryT<GConjugateGradientDescent, GConjugateGradientDescent_PersonalityTraits>;
