...
/**
 * @file
 * The plugin glue that turns the Mona-Lisa problem of example 15 into a RUNTIME-LOADABLE module carrying
 * TWO contributions in one shared object -- the optimization individual (GImageIndividual) AND its GPU
 * marshaller (GMonaLisaGPUMarshaller). This is the GPU-problem pattern of example 22 applied to a real,
