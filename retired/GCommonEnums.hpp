...
/******************************************************************************/
/**
 * "Common"-types for which an operator<< and operator>> should be defined
 */
using allowed_common_enums
= boost::mpl::vector<
	Gem::Common::dimensions
	, Gem::Common::logType
	, Gem::Common::triboolStates
...
/******************************************************************************/
/**
 * Adds an operator<< to all "common" enum class types declared in allowed_common_enums.
 * An enum class is an enum type that is not implicitly convertible to an integer
 */
template<
	typename enum_type
	, class = typename std::enable_if<boost::mpl::contains<allowed_common_enums, enum_type>::value>::type
	, class = typename std::enable_if<std::is_enum<enum_type>::value && !std::is_convertible<enum_type, Gem::Common::ENUMBASETYPE>::value>::type
>
std::ostream &operator<<(std::ostream &o, const enum_type &x) {
...
#ifdef DEBUG
	x = boost::numeric_cast<enum_type>(tmp);
#else
