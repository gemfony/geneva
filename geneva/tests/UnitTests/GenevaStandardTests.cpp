...
// GDScanPar, GFScanPar) lost their hand-written serialize() and now inherit the GBoilerplateT-generated
...
namespace {
class GPolicyProbe : public Gem::Common::GBoilerplateT<GPolicyProbe, Gem::Common::GCommonInterfaceT<GPolicyProbe>> {
