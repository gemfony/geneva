...
GOptimizableEntityFixedSizePriorityQueue::GOptimizableEntityFixedSizePriorityQueue(
  ...
  : Gem::Common::GBoilerplateT<GOptimizableEntityFixedSizePriorityQueue, Gem::Common::GFixedSizePriorityQueueT<GOptimizableEntity>>(
        max_size,
        Gem::Common::sortOrder::LOWERISBETTER
    ) { /* nothing */
}

// name_(), compare_(), load_() and clone_() are generated by the Gem::Common::GBoilerplateT
