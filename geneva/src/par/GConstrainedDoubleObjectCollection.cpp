...
BOOST_CLASS_EXPORT_IMPLEMENT(Gem::Geneva::Parameters::GConstrainedDoubleObjectCollection) // NOLINT
 ...
 */
GParameterBase *GConstrainedDoubleObjectCollection::clone_() const {
...
void GConstrainedDoubleObjectCollection::compare_(
    ...
    const GConstrainedDoubleObjectCollection *p_load =
        Gem::Common::g_convert_and_compare<GParameterBase, GConstrainedDoubleObjectCollection>(cp, this);
 ...
 *
 * @param cp A copy of another GConstrainedDoubleObjectCollection object, camouflaged as a GParameterBase
 */
void GConstrainedDoubleObjectCollection::load_(const GParameterBase *cp) {
...
void GConstrainedDoubleObjectCollection::fillWithObjects_(const std::size_t &n_added_objects) {
    ...
    for(std::size_t i = 0; i < n_added_objects; i++) {
        ...
        // Add the adaptor
        CHECK_NOTHROW(gcdo_ptr->addAdaptor(gdga_ptr));
...
void GConstrainedDoubleObjectCollection::specificTestsNoFailureExpected_GUnitTests_() {
    ...
    { // Call the parent class'es function
        std::shared_ptr<GConstrainedDoubleObjectCollection> p_test =
        ...
        p_test->GParameterTCollectionT<
            GConstrainedDoubleObject>::specificTestsNoFailureExpected_GUnitTests_();
    }

    // --------------------------------------------------------------------------

    { // Test the GParameterTCollectionT<T>::adapt implementation
        std::shared_ptr<GConstrainedDoubleObjectCollection> p_test1 =
            this->clone<GConstrainedDoubleObjectCollection>();
        std::shared_ptr<GConstrainedDoubleObjectCollection> p_test2 =
            this->clone<GConstrainedDoubleObjectCollection>();
    ...
    Gem::Common::condnotset(
        "GConstrainedDoubleObjectCollection::specificTestsFailuresExpected_GUnitTests",
        "GEM_TESTING"
    );
#endif                  /* GEM_TESTING */
}
