 ...
 */
GParameterBase *GParameterObjectCollection::clone_() const {
...
void GParameterObjectCollection::compare_(
    ...
    const GParameterObjectCollection *p_load =
        Gem::Common::g_convert_and_compare<GParameterBase, GParameterObjectCollection>(cp, this);
 ...
 *
 * @param cp A copy of another GParameterObjectCollection object, camouflaged as a GParameterBase
 */
void GParameterObjectCollection::load_(const GParameterBase *cp) {
...
void GParameterObjectCollection::specificTestsNoFailureExpected_GUnitTests_() {
    ...
    { // Call the parent class'es function
        std::shared_ptr<GParameterObjectCollection> p_test =
            this->clone<GParameterObjectCollection>();
        ...
        p_test
            ->GParameterTCollectionT<GParameterBase>::specificTestsNoFailureExpected_GUnitTests_();
    }

    //------------------------------------------------------------------------------

    { // Test that the fpFixedValueInit() function only has an effect on fp parameters
        std::shared_ptr<GParameterObjectCollection> p_test1 =
            this->clone<GParameterObjectCollection>();
        std::shared_ptr<GParameterObjectCollection> p_test2 =
            this->clone<GParameterObjectCollection>();
    ...
    Gem::Common::condnotset(
        "GParameterObjectCollection::specificTestsNoFailureExpected_GUnitTests",
        "GEM_TESTING"
    );
#endif                  /* GEM_TESTING */
}
