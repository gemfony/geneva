...
const std::string GGeneralizedSimulatedAnnealing_PersonalityTraits::nickname = "gsa"; // NOLINT
 ...
 */
void GGeneralizedSimulatedAnnealing_PersonalityTraits::setPopulationPosition(std::size_t population_position) {
 ...
 */
std::size_t GGeneralizedSimulatedAnnealing_PersonalityTraits::getPopulationPosition() const {
 ...
 *
 * @return The mnemonic ("gsa") associated with this personality
 */
 ...
 */
void GGeneralizedSimulatedAnnealing_PersonalityTraits::compare_(
    ...
    const GGeneralizedSimulatedAnnealing_PersonalityTraits *p_load =
        Gem::Common::g_convert_and_compare<GPersonalityTraits, GGeneralizedSimulatedAnnealing_PersonalityTraits>(
            cp,
            this
        );

    GToken token("GGeneralizedSimulatedAnnealing_PersonalityTraits", e);
 ...
 */
void GGeneralizedSimulatedAnnealing_PersonalityTraits::load_(const GPersonalityTraits *cp) {
    const GGeneralizedSimulatedAnnealing_PersonalityTraits *p_load =
        Gem::Common::g_convert_and_compare<GPersonalityTraits, GGeneralizedSimulatedAnnealing_PersonalityTraits>(
            cp,
            this
 ...
 */
bool GGeneralizedSimulatedAnnealing_PersonalityTraits::modify_GUnitTests_() {
#ifdef GEM_TESTING
    bool result = false;
    ...
    Gem::Common::condnotset(
        "GGeneralizedSimulatedAnnealing_PersonalityTraits::modify_GUnitTests",
        "GEM_TESTING"
    );
    return false;
#endif /* GEM_TESTING */
 ...
 */
void GGeneralizedSimulatedAnnealing_PersonalityTraits::specificTestsNoFailureExpected_GUnitTests_() {
#ifdef GEM_TESTING
    GPersonalityTraits::specificTestsNoFailureExpected_GUnitTests_();

    {
        std::shared_ptr<GGeneralizedSimulatedAnnealing_PersonalityTraits> p_test =
            this->clone<GGeneralizedSimulatedAnnealing_PersonalityTraits>();
...
#else /* GEM_TESTING */
    Gem::Common::condnotset(
        "GGeneralizedSimulatedAnnealing_PersonalityTraits::specificTestsNoFailureExpected_GUnitTests",
        "GEM_TESTING"
    );
#endif /* GEM_TESTING */
}
 ...
 */
void GGeneralizedSimulatedAnnealing_PersonalityTraits::specificTestsFailuresExpected_GUnitTests_() {
#ifdef GEM_TESTING
    GPersonalityTraits::specificTestsFailuresExpected_GUnitTests_();
#else /* GEM_TESTING */
    Gem::Common::condnotset(
        "GGeneralizedSimulatedAnnealing_PersonalityTraits::specificTestsFailuresExpected_GUnitTests",
        "GEM_TESTING"
    );
#endif /* GEM_TESTING */
}
