 ...
 */
void GSwarmAlgorithm_PersonalityTraits::registerPersonalBest(std::shared_ptr<gpar::GTreeGenome> p) {
    // Some error checking
#ifdef DEBUG
 ...
 */
std::shared_ptr<gpar::GTreeGenome> GSwarmAlgorithm_PersonalityTraits::getPersonalBest() const {
#ifdef DEBUG
...
void GSwarmAlgorithm_PersonalityTraits::resetPersonalBest() {
    personal_best_ = std::shared_ptr<gpar::GTreeGenome>(); // empty
