...
GSwarmAlgorithm_PersonalityTraits::GSwarmAlgorithm_PersonalityTraits(
  ...
  : Gem::Common::GBoilerplateT<GSwarmAlgorithm_PersonalityTraits, GPersonalityTraits>(cp)
...
// Gem::Common::GBoilerplateT base from class_name and localMembers_() (personal_best_
...
// load_() is generated by the Gem::Common::GBoilerplateT base from localMembers_()
