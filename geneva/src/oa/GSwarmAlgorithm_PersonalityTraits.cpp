 ...
 */
void GSwarmAlgorithm_PersonalityTraits::registerPersonalBest(std::shared_ptr<gpar::GParameterTree> p) {
    // Some error checking
#ifdef DEBUG
 ...
 */
std::shared_ptr<gpar::GParameterTree> GSwarmAlgorithm_PersonalityTraits::getPersonalBest() const {
#ifdef DEBUG
...
void GSwarmAlgorithm_PersonalityTraits::resetPersonalBest() {
    personal_best_ = std::shared_ptr<gpar::GParameterTree>(); // empty
