...
// The constructors, getMnemonic(), getAlgorithmName() and getObject_() are all generated by the
// GOptimizationAlgorithmFactoryT scaffold; postProcess_() is inherited from GOAFactoryT. Only the
// self-registration below remains.
