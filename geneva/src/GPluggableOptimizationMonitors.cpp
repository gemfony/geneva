...
// Gem::Common::GBoilerplateT from class_name and the empty localMembers_().
...
GFitnessMonitor::GFitnessMonitor(const GFitnessMonitor &cp)
  : Gem::Common::GBoilerplateT<GFitnessMonitor, oa::GBasePluggableOM>(cp)
  , x_dim_(cp.x_dim_)
  , y_dim_(cp.y_dim_)
...
GCollectiveMonitor::GCollectiveMonitor(const GCollectiveMonitor &cp)
  : Gem::Common::GBoilerplateT<GCollectiveMonitor, oa::GBasePluggableOM>(cp) {
...
// Gem::Common::GBoilerplateT from class_name and localMembers_() (serialize() kept in header).
...
// name_() and compare_() for GAllSolutionFileLogger are generated by Gem::Common::GBoilerplateT.
...
// load_() and clone_() for GAllSolutionFileLogger are generated by Gem::Common::GBoilerplateT.
...
// name_() and compare_() for GIterationResultsFileLogger are generated by Gem::Common::GBoilerplateT.
...
// load_() and clone_() for GIterationResultsFileLogger are generated by Gem::Common::GBoilerplateT.
...
GNAdpationsLogger::GNAdpationsLogger(const GNAdpationsLogger &cp)
  : Gem::Common::GBoilerplateT<GNAdpationsLogger, oa::GBasePluggableOM>(cp)
...
// compare_() for GNAdpationsLogger is generated by Gem::Common::GBoilerplateT.
...
// load_() and clone_() for GNAdpationsLogger are generated by Gem::Common::GBoilerplateT.
...
// name_() and compare_() for GProcessingTimesLogger are generated by Gem::Common::GBoilerplateT.
...
// load_() and clone_() for GProcessingTimesLogger are generated by Gem::Common::GBoilerplateT
