 ...
 */
class GExpImageIndividual : public gpar::GParameterSet {
    ///////////////////////////////////////////////////////////////////////
...
public:
    ...
    GExpImageIndividual(const GExpImageIndividual &);
    /** @brief The standard destructor */
    virtual ~GExpImageIndividual();
    ...
    static void addContent(
        ...
        if(startValues.empty()) {
            glogger << "In GExpImageIndividual::addContent(): Error!" << '\n'
                    << "No parameters given" << '\n'
                    << GTERMINATION;
        }
...
protected:
    /***************************************************************************/
    /** @brief Loads the data of another GExpImageIndividual */
    virtual void load_(const gpar::GParameterSet *) final;

    /** @brief Allow access to this classes compare_ function */
    friend void Gem::Common::compare_base_t<GExpImageIndividual>(
        GExpImageIndividual const &,
        GExpImageIndividual const &,
        Gem::Common::GToken &
    );
...
/** @brief Allows to output a GExpImageIndividual or convert it to a string using boost::lexical_cast */
std::ostream &operator<<(std::ostream &, std::shared_ptr<GExpImageIndividual>);

/******************************************************************************/
////////////////////////////////////////////////////////////////////////////////
/******************************************************************************/
/**
 * A factory for GExpImageIndividual objects
 */
class GExpImageIndividualFactory : public Gem::Common::GFactoryT<gpar::GParameterSet> {
public:
    /** @brief The standard constructor */
    explicit GExpImageIndividualFactory(std::filesystem::path const &);
    /** @brief The destructor */
    ~GExpImageIndividualFactory() override = default;
...
private:
    ...
    GExpImageIndividualFactory() = default;
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::GExpImageIndividual) // NOLINT
