 ...
 */
class GFloatCollection // NOLINT(cppcoreguidelines-special-member-functions)
  : public GFPNumCollectionT<float> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            "GFPNumCollectionT_double",
            boost::serialization::base_object<GFPNumCollectionT<float>>(*this)
        );
    }
    ///////////////////////////////////////////////////////////////////////
...
public:
    ...
    GFloatCollection() = default;
    /** @brief The copy constructor */
    GFloatCollection(const GFloatCollection &) = default;
    /** @brief Initialization with a number of random values in a given range */
    GFloatCollection(const std::size_t &, const float &, const float &);
    /** @brief Initialization with a number of predefined values in all positions */
    
    GFloatCollection(const std::size_t &, const float &, const float &, const float &);
    /** @brief The destructor */
    ~GFloatCollection() override = default;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GFloatCollection>(
        GFloatCollection const &,
        GFloatCollection const &,
        Gem::Common::GToken &
    );
...
private:
    ...
    void fillWithData_(const std::size_t &);
};
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GFloatCollection) // NOLINT
