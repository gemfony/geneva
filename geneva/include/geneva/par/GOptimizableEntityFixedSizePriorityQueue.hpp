...
class GOptimizableEntityFixedSizePriorityQueue // NOLINT(cppcoreguidelines-special-member-functions)
  : public Gem::Common::GBoilerplateT<GOptimizableEntityFixedSizePriorityQueue, Gem::Common::GFixedSizePriorityQueueT<GOptimizableEntity>> {
    ///////////////////////////////////////////////////////////////////////
    // boost::serialization::access default-constructs this concrete type on load;
    // GBoilerplateAccess lets the mixin reach the (empty) localMembers_().
...
public:
     ...
     */
    void add(std::shared_ptr<GOptimizableEntity> const &item_ptr, const bool do_clone) override;
     ...
     * @param replace If true, the queue's existing content is replaced rather than merged with the new items
     */
    void add(std::vector<std::unique_ptr<GOptimizableEntity>> const &items_cnt, bool do_clone, bool do_replace);
    /**
...
protected:
    ...
    // Gem::Common::GBoilerplateT base from class_name and the empty localMembers_().
