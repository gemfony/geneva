...
protected:
    ...
    /**
	  ...
	  *
	  * @param cp A copy of another GNumIntT<int_type> object, camouflaged as a GParameterBase
	  */
    void load_(const GParameterBase *cp) override {
        ...
        const GNumIntT<int_type> *p_load =
            Gem::Common::g_convert_and_compare<GParameterBase, GNumIntT<int_type>>(cp, this);
...
template <typename int_type>
struct is_abstract<Gem::Geneva::Parameters::GNumIntT<int_type>> : public boost::true_type {};
template <typename int_type>
struct is_abstract<const Gem::Geneva::Parameters::GNumIntT<int_type>> : public boost::true_type {};
} /* namespace boost::serialization */
/******************************************************************************/
