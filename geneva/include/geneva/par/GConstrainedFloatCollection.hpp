 ...
 */
class GConstrainedFloatCollection // NOLINT(cppcoreguidelines-special-member-functions)
  : public GConstrainedFPNumCollectionT<float> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            boost::serialization::base_object<GConstrainedFPNumCollectionT<float>>(*this)
        );
    }
    ///////////////////////////////////////////////////////////////////////
...
public:
    ...
    GConstrainedFloatCollection(const std::size_t &, const float &, const float &);
    ...
    GConstrainedFloatCollection(const GConstrainedFloatCollection &) = default;
    /** @brief The standard destructor */
    ~GConstrainedFloatCollection() override = default;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GConstrainedFloatCollection>(
        GConstrainedFloatCollection const &,
        GConstrainedFloatCollection const &,
        Gem::Common::GToken &
    );
    ...
    GConstrainedFloatCollection() = default;
...
/******************************************************************************/
/**
 * As Gem::Geneva::Parameters::GConstrainedFloatCollection has a private default constructor, we need to provide a
 * specialization of the factory function that creates objects of this type.
 */
template <>
inline std::shared_ptr<Gem::Geneva::Parameters::GConstrainedFloatCollection>
TFactory_GUnitTests<Gem::Geneva::Parameters::GConstrainedFloatCollection>() {
    constexpr std::size_t nparameters = 100;
    float lowerboundary = -10.;
    float upperboundary = 10.;
    std::shared_ptr<Gem::Geneva::Parameters::GConstrainedFloatCollection> p;
    CHECK_NOTHROW(
        p = std::make_shared<Gem::Geneva::Parameters::GConstrainedFloatCollection>(
            nparameters,
            lowerboundary,
            upperboundary
        )
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GConstrainedFloatCollection) // NOLINT
/******************************************************************************/
