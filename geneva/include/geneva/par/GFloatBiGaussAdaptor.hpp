 ...
 * float values through the addition of bi-gaussian-distributed random numbers.
 * It is the single-precision sibling of GDoubleBiGaussAdaptor; see the documentation
 ...
 */
class GFloatBiGaussAdaptor // NOLINT(cppcoreguidelines-special-member-functions)
  : public GFPBiGaussAdaptorT<float> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            "GFPBiGaussAdaptorT_float",
            boost::serialization::base_object<GFPBiGaussAdaptorT<float>>(*this)
        );
    }
    ///////////////////////////////////////////////////////////////////////
...
public:
    ...
    GFloatBiGaussAdaptor() = default;
    /** @brief The copy constructor */
    GFloatBiGaussAdaptor(const GFloatBiGaussAdaptor &) = default;
    /** @brief Initialization with a adaption probability */
    explicit GFloatBiGaussAdaptor(const double &);
    /** @brief The destructor */
    ~GFloatBiGaussAdaptor() override = default;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GFloatBiGaussAdaptor>(
        GFloatBiGaussAdaptor const &,
        GFloatBiGaussAdaptor const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GFloatBiGaussAdaptor) // NOLINT
