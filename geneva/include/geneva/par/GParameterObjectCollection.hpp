...
public:
    ...
    std::shared_ptr<Gem::Geneva::Parameters::GParameterBase> at(const std::size_t &pos);
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GParameterObjectCollection) // NOLINT
