...
template <typename num_type>
struct is_abstract<Gem::Geneva::Parameters::GConstrainedNumCollectionT<num_type>> : public boost::true_type {};
template <typename num_type>
struct is_abstract<const Gem::Geneva::Parameters::GConstrainedNumCollectionT<num_type>>
