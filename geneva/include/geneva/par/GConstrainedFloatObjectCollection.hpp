  ...
  : public GParameterTCollectionT<GConstrainedFloatObject> {
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            boost::serialization::base_object<GParameterTCollectionT<GConstrainedFloatObject>>(
                *this
            )
        );
    }
...
public:
    ...
    GConstrainedFloatObjectCollection() = default;
    /** @brief Initialization with a number of GConstrainedFloatObject objects */
    GConstrainedFloatObjectCollection(
        const std::size_t &,
        std::shared_ptr<GConstrainedFloatObject>
    );
    /** @brief The copy constructor */
    
    GConstrainedFloatObjectCollection(const GConstrainedFloatObjectCollection &) = default;
    /** @brief The destructor */
    ~GConstrainedFloatObjectCollection() override = default;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GConstrainedFloatObjectCollection>(
        GConstrainedFloatObjectCollection const &,
        GConstrainedFloatObjectCollection const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GConstrainedFloatObjectCollection) // NOLINT
