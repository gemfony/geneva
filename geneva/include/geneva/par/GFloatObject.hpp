...
/******************************************************************************/
/**
 * This class encapsulates a float type. It is the single-precision sibling of
 * GDoubleObject. This might appear heavy weight, and indeed for most applications
 * this is not the recommended solution - use the GFloatCollection class or
 * individual GConstrainedFloatObject objects instead.
 */
class GFloatObject // NOLINT(cppcoreguidelines-special-member-functions)
...
public:
    ...
    GFloatObject() = default;
    /** @brief The copy constructor */
    GFloatObject(const GFloatObject &) = default;
    ...
    ~GFloatObject() override = default;

    /** @brief An assignment operator for the contained value type */
    GFloatObject &operator=(const float &) override;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GFloatObject>(
        GFloatObject const &,
        GFloatObject const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GFloatObject) // NOLINT
