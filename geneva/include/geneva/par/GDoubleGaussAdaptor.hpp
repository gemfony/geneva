 ...
 */
class GDoubleGaussAdaptor // NOLINT(cppcoreguidelines-special-member-functions)
...
public:
    ...
    GDoubleGaussAdaptor() = default;
    /** @brief The copy constructor */
    GDoubleGaussAdaptor(const GDoubleGaussAdaptor &) = default;
    ...
    ~GDoubleGaussAdaptor() override = default;

protected:
    /** @brief Loads the data of another GAdaptorT */
    void load_(const GAdaptorT<double> *) override;
    ...
    void compare_(
        const GAdaptorT<double> & // the other object
        ,
    ...
    GAdaptorT<double> *clone_() const override;
};
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::Parameters::GDoubleGaussAdaptor) // NOLINT
