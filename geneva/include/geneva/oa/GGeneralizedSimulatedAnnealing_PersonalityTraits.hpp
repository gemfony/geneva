...
public:
     ...
     *  @param cp Another GGeneralizedSimulatedAnnealing_PersonalityTraits object whose state is copied */
    GGeneralizedSimulatedAnnealing_PersonalityTraits(const GGeneralizedSimulatedAnnealing_PersonalityTraits &cp) = default;
    /** @brief The standard destructor */
    ~GGeneralizedSimulatedAnnealing_PersonalityTraits() override = default;

    /**
     * @brief Retrieves the mnemonic of the optimization algorithm.
     * @return The short mnemonic string identifying the generalized simulated annealing
     */
