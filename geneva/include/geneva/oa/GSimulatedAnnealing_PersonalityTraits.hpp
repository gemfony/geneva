...
class GSimulatedAnnealing_PersonalityTraits // NOLINT(cppcoreguidelines-special-member-functions)
  : public Gem::Common::GBoilerplateT<GSimulatedAnnealing_PersonalityTraits, GBaseParChildPersonalityTraits> {
    ///////////////////////////////////////////////////////////////////////
    // boost::serialization::access default-constructs this concrete type on load;
    // GBoilerplateAccess lets the GBoilerplateT base reach the (empty) localMembers_().
