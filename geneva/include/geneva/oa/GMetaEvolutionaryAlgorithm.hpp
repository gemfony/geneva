...
class GMetaEvolutionaryAlgorithm
  : public Gem::Common::GBoilerplateT<GMetaEvolutionaryAlgorithm, GEvolutionaryAlgorithm> {
protected:
    /***************************************************************************/
    /**
...
private:
    ...
    // Gem::Common::GBoilerplateT base from class_name and localMembers_(). The mixin's clone_() builds a
...
public:
    ...
    GMetaEvolutionaryAlgorithm(const GMetaEvolutionaryAlgorithm &cp)
      : Gem::Common::GBoilerplateT<GMetaEvolutionaryAlgorithm, GEvolutionaryAlgorithm>(cp) {
