...
public:
    ...
    static constexpr std::string_view oa_class_name = "GStandardPSO2011";
...
protected:
    ...
    /** @brief Loads the data of another GStandardPSO2011 object */
    void load_(const GOptimizationAlgorithmBase *cp) override;

    /** @brief Allow access to this classes compare_ function */
    friend void Gem::Common::compare_base_t<GStandardPSO2011>(
        GStandardPSO2011 const &,
        GStandardPSO2011 const &,
        Gem::Common::GToken &
    );
