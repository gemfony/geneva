...
class GParChild // NOLINT(cppcoreguidelines-special-member-functions)
  : public Gem::Common::GBoilerplateBaseT<GParChild, GOptimizationAlgorithmBase> {
    /////////////////////////////////////////////////////////////////////////////
     ...
     *  GBoilerplateBaseT-generated serialize()/load_()/compare_() from one place. */
...
public:
    ...
    static constexpr std::string_view class_name = "GParChild";
...
protected:
    ...
    // load_() and compare_() are generated by the Gem::Common::GBoilerplateBaseT base.
