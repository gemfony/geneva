...
public:
    ...
    static constexpr std::string_view oa_class_name = "GAntColonyOptimization";
...
protected:
    ...
    /** @brief Loads the data of another GAntColonyOptimization object */
    void load_(const GOptimizationAlgorithmBase *cp) override;

    /** @brief Allow access to this classes compare_ function */
    friend void Gem::Common::compare_base_t<GAntColonyOptimization>(
        GAntColonyOptimization const &,
        GAntColonyOptimization const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::OptimizationAlgorithms::GAntColonyOptimization) // NOLINT
