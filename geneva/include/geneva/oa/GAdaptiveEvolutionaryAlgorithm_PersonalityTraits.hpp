...
public:
    ...
    GAdaptiveEvolutionaryAlgorithm_PersonalityTraits() = default;
    /**
     * @brief The copy contructor.
     * @param The object to be copied
     */
    GAdaptiveEvolutionaryAlgorithm_PersonalityTraits(
        const GAdaptiveEvolutionaryAlgorithm_PersonalityTraits &
    ) = default;
    /** @brief The standard destructor */
    ~GAdaptiveEvolutionaryAlgorithm_PersonalityTraits() override = default;
...
protected:
    ...
    friend void Gem::Common::compare_base_t<GAdaptiveEvolutionaryAlgorithm_PersonalityTraits>(
        GAdaptiveEvolutionaryAlgorithm_PersonalityTraits const &,
        GAdaptiveEvolutionaryAlgorithm_PersonalityTraits const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::OptimizationAlgorithms::GAdaptiveEvolutionaryAlgorithm_PersonalityTraits) // NOLINT
