 ...
 * position in the population (its scan-grid slot), which the
...
class GParameterScan_PersonalityTraits // NOLINT(cppcoreguidelines-special-member-functions)
  : public GAlgorithmPersonalityTraitsT<GParameterScan_PersonalityTraits> {
...
public:
    ...
    static constexpr std::string_view class_name{"GParameterScan_PersonalityTraits"};
};
