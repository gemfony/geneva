...
public:
    ...
    static constexpr std::string_view oa_class_name = "GGeneralizedSimulatedAnnealing";
...
protected:
    ...
    /** @brief Loads the data of another GGeneralizedSimulatedAnnealing object */
    void load_(const GOptimizationAlgorithmBase *cp) override;

    /** @brief Allow access to this classes compare_ function */
    friend void Gem::Common::compare_base_t<GGeneralizedSimulatedAnnealing>(
        GGeneralizedSimulatedAnnealing const &,
        GGeneralizedSimulatedAnnealing const &,
        Gem::Common::GToken &
    );
...
BOOST_CLASS_EXPORT_KEY(Gem::Geneva::OptimizationAlgorithms::GGeneralizedSimulatedAnnealing) // NOLINT
