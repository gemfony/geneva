...
class GMPISubClientIndividual // NOLINT(cppcoreguidelines-special-member-functions)
  : public Gem::Common::GBoilerplateBaseT<GMPISubClientIndividual, gen::GGenome> {
    ...
    /** @brief The GBoilerplateBaseT mixin reaches the (empty) private localMembers_() through this shim. */
     ...
     *  member list is empty; name_()/load_()/compare_()/serialize() are generated by the GBoilerplateBaseT
