...
class GGenome // NOLINT(cppcoreguidelines-special-member-functions)
  : public Gem::Common::GBoilerplateBaseT<GGenome, GOptimizableEntity> {
    ///////////////////////////////////////////////////////////////////////
     ...
     *  GBoilerplateBaseT-generated name_()/load_()/compare_() AND the hand-written save()/load() from one
    ...
    /** @brief Post-load hook (invoked by the GBoilerplateBaseT-generated load_() after the members are
...
protected:
    // load_() and compare_() are generated by the Gem::Common::GBoilerplateBaseT base from
