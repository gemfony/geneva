...
class GEvolutionaryAlgorithmPostOptimizer // NOLINT(cppcoreguidelines-special-member-functions)
  : public GPostProcessorBaseT<gpar::GParameterTree> {
    ///////////////////////////////////////////////////////////////////////
    friend class boost::serialization::access;
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            boost::serialization::base_object<GPostProcessorBaseT<gpar::GParameterTree>>(*this)
...
protected:
    ...
    void
    load_(const Gem::Common::GSerializableFunctionObjectT<gpar::GParameterTree> *cp) override;
    ...
    bool raw_processing_(gpar::GParameterTree &p) override;
...
private:
    ...
    Gem::Common::GSerializableFunctionObjectT<gpar::GParameterTree> *clone_() const override;
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(Gem::Geneva::GPostProcessorBaseT<gpar::GParameterTree>) // NOLINT
