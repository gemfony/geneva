...
class GEvolutionaryAlgorithmPostOptimizer // NOLINT(cppcoreguidelines-special-member-functions)
  : public GPostProcessorBaseT<gpar::GTreeGenome> {
    ///////////////////////////////////////////////////////////////////////
    friend class boost::serialization::access;
    ...
    void serialize(Archive &ar, const unsigned int) {
        ...
        ar &make_nvp(
            ...
            boost::serialization::base_object<GPostProcessorBaseT<gpar::GTreeGenome>>(*this)
...
protected:
    ...
    void
    load_(const Gem::Common::GSerializableFunctionObjectT<gpar::GTreeGenome> *cp) override;
    ...
    bool raw_processing_(gpar::GTreeGenome &p) override;
...
private:
    ...
    Gem::Common::GSerializableFunctionObjectT<gpar::GTreeGenome> *clone_() const override;
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(Gem::Geneva::GPostProcessorBaseT<gpar::GTreeGenome>) // NOLINT
