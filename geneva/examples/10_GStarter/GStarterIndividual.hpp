...
class GStarterIndividual : public gen::GGenomeT<GStarterIndividual> {
    ...
    /**
     * @brief Single declaration of this class'es local data members. The GBoilerplateT mixin (via
...
public:
    /** @brief The class name, consumed by the GBoilerplateT-generated name_() and the compare token. */
...
protected:
    /***************************************************************************/
    // load_(), compare_(), clone_() and name_() are generated by the Gem::Common::GBoilerplateT base
